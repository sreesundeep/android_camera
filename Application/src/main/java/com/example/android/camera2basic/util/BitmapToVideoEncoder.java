...
public class BitmapToVideoEncoder {
    ...
    public void startEncoding(int width, int height, File outputFile) {
        ...
        try {
            mediaMuxer =
                    new MediaMuxer(outputFileString, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
        } catch (IOException e) {
    ...
    private void encode() {
        ...
        while (!mNoMoreFrames || (mEncodeQueue.size() != 0) || mGenerateIndex<20) {
